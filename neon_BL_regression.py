...
import gc
import psutil
from TripletNetwork_Online import continuous_regression2
...
if __name__ == "__main__":
    ...
    for run in range(parameters['runs']):
        ...
        experiment_name = f"{modality_chosen}_BL_REG_{run_number}"
...
#             val_embeddings = val_embeddings_mm[:, 2048:3072]
        ...
        model = continuous_regression2(EMB_DIM = train_embeddings.shape[1])
