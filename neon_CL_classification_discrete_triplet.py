...
def load_embedding_model(modality, run, cls_weight, patch_size):
    ...
    model = load_model(f'/blue/azare/zhou.m/commanet/ground_truth_points_HARVARD/trained_models/image_reconstruction/discrete_triplet/noL2/{modality}/class_10/patch_size_{patch_size}/_emb1024_batch32_margin0.1_test_size{test_size}_cls_weight0.5_best_val_model_run_{run}.h5',
        compile=False
    )
...
#     model = load_model(f'/blue/azare/zhou.m/commanet/ground_truth_points_HARVARD/trained_models/image_reconstruction/class_triplet/noL2/{modality}/{modality}_emb1024_batch32_margin0.1_test_size{test_size}_best_val_model_run_{run}.h5',
#         compile=False
#     )
#     return Model(inputs=model.layers[1].input, outputs=model.layers[1].output)
...
if __name__ == "__main__":
    ...
    base_save_path = os.getcwd() + "/trained_models/discrete_class_label_classification/discrete_triplet/noL2/CCE/"
