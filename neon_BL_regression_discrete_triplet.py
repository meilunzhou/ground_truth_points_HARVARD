...
if __name__ == "__main__":
    ...
    base_save_path = os.getcwd() + "/trained_models/continuous_box_label_regression/discrete_triplet/noL2/MSE/"
...
#         val_embeddings_mm, _, _, _, _, _, _, _, _, _ = embedding_model_multimodal.predict([X_rgb_val, X_lidar_val, X_hsi_val])
        ...
        if modality_chosen == 'rgb':
            ...
            # train_embeddings = train_embeddings_mm
            # val_embeddings = val_embeddings_mm
