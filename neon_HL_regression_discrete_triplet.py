...
if __name__ == "__main__":
    ...
    test_imgs, test_indices = center_crop_on_box(f['rgb'], f['box_labels']*10, 60)
    ...
    base_save_path = os.getcwd() + "/trained_models/continuous_height_label_regression/discrete_triplet/noL2/MSE/"
