...
import gc
import psutil
from TripletNetwork_Online import image_reconstruction, image_reconstruction_4x4, image_reconstruction_6x6, image_reconstruction_7x7, image_reconstruction_11x11
...
from neon_custom_losses import keras_batch_all_triplet_loss, ciou_loss, dice_loss, ssim_loss, mean_squared_loss, hybrid_hsi_loss, rgb_ssim_loss
...
# }
    ...
    base_save_path = os.getcwd() + "/trained_models/image_reconstruction/without_triplet/noL2/"
    ...
    for run in range(parameters['runs']):
        ...
        experiment_name = f"{modality_chosen}_no_triplet_image_recon_{run_number}"
        ...
        # model = image_reconstruction_11x11(S1_DIM, modality=modality_chosen)
        model = image_reconstruction_4x4(S1_DIM, modality=modality_chosen)
        
        model.compile(optimizer=Adam(0.0001), loss=chosen_loss)
