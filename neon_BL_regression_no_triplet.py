...
def load_embedding_model(modality, run, cls_weight, patch_size):
    ...
    model = load_model(f'/blue/azare/zhou.m/commanet/ground_truth_points_HARVARD/trained_models/image_reconstruction/without_triplet/noL2/{modality}/class_10/patch_size_{patch_size}/_emb1024_batch32_margin0.1_test_size{test_size}_cls_weight0.5_best_val_model_run_{run}.h5', compile=False)
...
if __name__ == "__main__":
    ...
    base_save_path = os.getcwd() + "/trained_models/continuous_box_label_regression/without_triplet/noL2/MSE/"
